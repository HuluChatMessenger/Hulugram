...
public class FolderIcons {
    ...
    static {
        ...
        //plus
        folderIcons.put("user",R.drawable.filter_private);
        folderIcons.put("lock",R.drawable.filter_mask);
        folderIcons.put("online",R.drawable.filter_cat);
        folderIcons.put("group",R.drawable.filter_groups);
        folderIcons.put("channel",R.drawable.filter_channel);
        folderIcons.put("bot",R.drawable.filter_bot);
        folderIcons.put("crown",R.drawable.filter_crown);
        folderIcons.put("super_group",R.drawable.filter_groups);
        folderIcons.put("chat_admin",R.drawable.filter_work);
        folderIcons.put("unread_chat",R.drawable.filter_unread);
    ...
    public static int getPaddingTab() {
        if (PlusConfig.tabIcons != 2 || PlusConfig.tabStyle >= 3) {
