...
import static plus.utils.cache.CacheFragment.UNKNOWN_CHATS_DIALOG_ID;
...
//            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case VIEW_TYPE_CHAT:
                    CacheFragment.UserCell userCell = new CacheFragment.UserCell(getContext(), null);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_CHAT:
                    CacheFragment.UserCell userCell = (CacheFragment.UserCell) holder.itemView;
                    CacheFragment.DialogFileEntities dialogFileEntities = itemInners.get(position).entities;
    ...
    private class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public ItemInner(int viewType, CacheFragment.DialogFileEntities entities) {
            super(viewType, true);
    ...
    public interface Delegate {
        void onItemSelected(CacheFragment.DialogFileEntities entities, CacheModel.FileInfo fileInfo, boolean longPress);
